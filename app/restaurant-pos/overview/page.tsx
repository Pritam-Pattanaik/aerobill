                    ...
                    <div>
                        ...
                        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
                            {[
                                ...
                                { title: "Restaurant Inventory Management Software", desc: "Avoid stock shortages and reduce wastage with smart restaurant inventory management software. Track ingredients, monitor usage, and optimize purchasing decisions.", link: "Learn more about Inventory Management Software", url: "/restaurant-pos/inventory-management", icon: "📦" },
