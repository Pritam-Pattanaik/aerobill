                    ...
                    <div>
                        ...
                        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
                            {[
                                ...
                                { title: "QR Code Ordering System for Restaurants", desc: "Enhance customer convenience with a modern QR code ordering system for restaurants. Customers can scan, view menus, and place orders directly from their phones.", link: "Discover QR Code Ordering System", url: "/restaurant-pos/qr-code-ordering", icon: "📱" },
