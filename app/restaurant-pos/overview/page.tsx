                ...
                <div className="py-12 space-y-20">
                    ...
                    <div>
                        ...
                        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
                            {[
                                { title: "Restaurant Billing Software", desc: "Fast and accurate billing is the backbone of any restaurant. Aerobill offers advanced restaurant billing software with GST compliance, quick invoice generation, and smooth payment processing.", link: "Explore our Restaurant Billing Software", url: "/restaurant-pos/restaurant-billing-software", icon: "🧾" },
                                { title: "Restaurant Inventory Management Software", desc: "Avoid stock shortages and reduce wastage with smart restaurant inventory management software. Track ingredients, monitor usage, and optimize purchasing decisions.", link: "Learn more about Inventory Management Software", url: "/restaurant-pos/inventory-management-software", icon: "📦" },
                                { title: "QR Code Ordering System for Restaurants", desc: "Enhance customer convenience with a modern QR code ordering system for restaurants. Customers can scan, view menus, and place orders directly from their phones.", link: "Discover QR Code Ordering System", url: "/restaurant-pos/qr-code-ordering-system", icon: "📱" },
                                { title: "KOT (Kitchen Order Ticket) System", desc: "Ensure seamless communication between kitchen and billing with a reliable KOT system for restaurants, reducing delays and improving order accuracy.", link: "Check KOT System", url: "/restaurant-pos/kot-system", icon: "🎫" },
                                { title: "Table Management System for Restaurants", desc: "Efficient seating and faster service are possible with a smart table management system for restaurants.", link: "View Table Management System", url: "/restaurant-pos/table-management-system", icon: "🪑" },
                                { title: "Kitchen Display System (KDS)", desc: "Replace traditional paper tickets with a digital kitchen display system (KDS) for restaurants. Improve kitchen efficiency, reduce errors, and ensure faster order preparation with real-time updates.", link: "Explore Kitchen Display System", url: "/restaurant-pos/kitchen-display-system", icon: "📺" },
                                { title: "Restaurant Analytics & Reporting", desc: "Make smarter decisions with powerful restaurant analytics and reporting software. Track sales, monitor performance, and gain valuable insights to grow your business.", link: "View Analytics & Reporting", url: "/restaurant-pos/restaurant-analytics-reporting", icon: "📊" },
                                { title: "Cloud Kitchen Management", desc: "Manage your cloud kitchen operations effortlessly with dedicated cloud kitchen management software. Handle multiple online orders, streamline workflows, and optimize delivery performance.", link: "Discover Cloud Kitchen Software", url: "/restaurant-pos/cloud-kitchen-management-software", icon: "☁️" },
                                { title: "Multi-Outlet Management", desc: "Easily manage multiple branches with centralized multi-outlet restaurant management software. Monitor sales, inventory, and staff across all locations from a single dashboard.", link: "Explore Multi-Outlet Management", url: "/restaurant-pos/restaurant-analytics-reporting", icon: "🏪" },
                                { title: "GST Billing Software", desc: "Stay compliant with Indian tax regulations using reliable GST billing software for restaurants. Generate accurate invoices, manage taxes, and simplify your accounting process.", link: "Learn more about GST Billing", url: "/restaurant-pos/restaurant-billing-software", icon: "💰" },
                                { title: "Order Management System", desc: "Streamline your entire order process with an efficient restaurant order management system. Manage dine-in, takeaway, and online orders from one unified platform.", link: "Check Order Management", url: "/restaurant-pos/table-management-system", icon: "🛍️" },
                            ].map((feature, i) => (
                                <Link href={feature.url} key={i} className="group relative bg-[#111111]/80 backdrop-blur-sm border border-white/5 rounded-2xl p-8 hover:bg-gradient-to-br hover:from-white/5 hover:to-transparent hover:border-white/10 transition-all duration-300 flex flex-col hover:-translate-y-1 shadow-lg overflow-hidden">
                                    <div className="w-12 h-12 bg-gradient-to-br from-[#ff6b35]/20 to-purple-500/20 rounded-xl flex items-center justify-center text-2xl mb-6 shadow-inner border border-white/5 group-hover:scale-110 transition-transform duration-300">
                                        {feature.icon}
                                    </div>
                                    <h3 className="text-xl font-bold text-white mb-3 group-hover:text-[#ff6b35] transition-colors">{feature.title}</h3>
                                    <p className="text-gray-400 mb-8 flex-grow leading-relaxed">{feature.desc}</p>
                                    <div className="flex items-center gap-2 text-[#ff6b35] text-sm font-semibold opacity-80 group-hover:opacity-100 transition mt-auto">
