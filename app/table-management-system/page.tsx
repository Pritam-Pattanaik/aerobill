...
export const metadata: Metadata = {
  ...
  description: 'Optimize seating and turn tables faster.'
};
    ...
    <div className="min-h-screen bg-[#0a0a0a] text-gray-300 flex flex-col">
      ...
      <div className="flex-1 flex flex-col items-center justify-center pt-32 pb-12 px-4">
          <div className="text-center max-w-2xl">
            <h1 className="text-4xl md:text-5xl font-bold text-white mb-6">Table Management System</h1>
            <p className="text-xl text-gray-400 mb-8">Optimize seating and turn tables faster.</p>
