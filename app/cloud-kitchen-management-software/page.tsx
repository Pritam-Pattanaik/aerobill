...
export const metadata: Metadata = {
  title: 'Cloud Kitchen Software | Aerobill',
  description: 'Unified dashboard for all aggregator orders.'
};
    ...
    <div className="min-h-screen bg-[#0a0a0a] text-gray-300 flex flex-col">
      ...
      <div className="flex-1 flex flex-col items-center justify-center pt-32 pb-12 px-4">
          <div className="text-center max-w-2xl">
            <h1 className="text-4xl md:text-5xl font-bold text-white mb-6">Cloud Kitchen Software</h1>
            <p className="text-xl text-gray-400 mb-8">Unified dashboard for all aggregator orders.</p>
