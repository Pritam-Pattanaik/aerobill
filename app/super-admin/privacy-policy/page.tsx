...
import { getPrivacyPolicy, updatePrivacyPolicy } from "@/app/actions/legal"
...
export default function PrivacyPolicyAdminPage() {
    ...
    return (
        <div className="p-6 max-w-4xl mx-auto">
            <div className="mb-8">
                <h1 className="text-3xl font-bold mb-2">Privacy Policy Settings</h1>
                <p className="text-gray-400">Manage the content of the public Privacy Policy page.</p>
            </div>
