...
import { getRefundPolicy, updateRefundPolicy } from "@/app/actions/legal"
...
export default function RefundPolicyAdminPage() {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        const result = await updateRefundPolicy(content)

        if (result.success) {
            setMessage({ type: "success", text: "Cancellation & Refund Policy updated successfully!" })
        } else {
    ...
    return (
        <div className="p-6 max-w-4xl mx-auto">
            <div className="mb-8">
                <h1 className="text-3xl font-bold mb-2">Cancellation & Refund Policy Settings</h1>
                <p className="text-gray-400">Manage the content of the public Cancellation & Refund Policy page.</p>
            </div>
