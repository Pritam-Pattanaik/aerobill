...
import { getTermsConditions, updateTermsConditions } from "@/app/actions/legal"
...
export default function TermsConditionsAdminPage() {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        const result = await updateTermsConditions(content)
    ...
    return (
        <div className="p-6 max-w-4xl mx-auto">
            <div className="mb-8">
                <h1 className="text-3xl font-bold mb-2">Terms and Conditions Settings</h1>
                <p className="text-gray-400">Manage the content of the public Terms and Conditions page.</p>
            </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
                <div className="glass-card p-6">
                    <h2 className="text-xl font-semibold mb-4">📝 Terms Content (Markdown)</h2>
